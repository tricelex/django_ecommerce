...
//be followed.
    ...
    S2.define('select2/dropdown/attachBody', [
      ...
      AttachBody.prototype._positionDropdown = function() {
        ...
        var enoughRoomBelow = viewport.bottom >
            (offset.bottom + dropdown.height);
    ...
    S2.define('select2/dropdown/minimumResultsForSearch', [], function() {
      ...
      function MinimumResultsForSearch(
          decorated, $element, options, dataAdapter) {
    ...
    S2.define('select2/i18n/en', [], function() {
      ...
      return {
        ...
        inputTooShort: function(args) {
          ...
          var message = 'Please enter ' + remainingChars +
              ' or more characters';
    ...
    S2.define('select2/defaults', [
      ...
      Defaults.prototype._resolveLanguage = function(language) {
        ...
        for (var l = 0; l < languages.length; l++) {
          ...
          if (typeof languages[l] === 'string' && languages[l].indexOf('-') >
              0) {
            ...
            try {
              ...
              try {
                ...
                if (debug && window.console && console.warn) {
                  console.warn(
                      'Select2: The language file for "' + language +
                      '" could ' +
    ...
    S2.define('select2/core', [
      ...
      Select2.prototype.destroy = function() {
        ...
        if (this._observer != null) {
          ...
          this.$element[0].removeEventListener('DOMAttrModified', this._syncA,
              false);
          this.$element[0].removeEventListener('DOMNodeInserted', this._syncS,
              false);
          this.$element[0].removeEventListener('DOMNodeRemoved', this._syncS,
              false);
        }
    ...
    S2.define('select2/compat/containerCss', [
      ...
      ContainerCSS.prototype.render = function(decorated) {
        ...
        CompatUtils.syncCssClasses($container, this.$element,
            containerCssAdapter);
    ...
    S2.define('select2/compat/dropdownCss', [
      ...
      DropdownCSS.prototype.render = function(decorated) {
        ...
        CompatUtils.syncCssClasses($dropdown, this.$element,
            dropdownCssAdapter);
