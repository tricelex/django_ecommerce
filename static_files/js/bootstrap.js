...
(function(global, factory) {
  ...
  $(document).
      ...
      on(Event$1.FOCUS_BLUR_DATA_API, Selector$1.DATA_TOGGLE_CARROT,
          function(event) {
      ...
      function() {
        ...
        _proto._addTouchEventListeners = function _addTouchEventListeners() {
          ...
          var end = function end(event) {
            if (_this3._pointerEvent &&
                PointerType[event.originalEvent.pointerType.toUpperCase()]) {
              _this3.touchDeltaX = event.originalEvent.clientX -
                  _this3.touchStartX;
            }
        ...
        _proto._slide = function _slide(direction, element) {
          ...
          if ($(this._element).hasClass(ClassName$2.SLIDE)) {
            ...
            var nextElementInterval = parseInt(
                nextElement.getAttribute('data-interval'), 10);
            ...
            $(activeElement).one(Util.TRANSITION_END, function() {
              ...
              $(activeElement).
                  removeClass(ClassName$2.ACTIVE + ' ' + orderClassName + ' ' +
  ...
  $(document).
      on(Event$2.CLICK_DATA_API, Selector$2.DATA_SLIDE,
  ...
  var Collapse =
      ...
      function() {
        ...
        _proto.show = function show() {
          ...
          if (this._parent) {
            actives = [].slice.call(
                this._parent.querySelectorAll(Selector$3.ACTIVES)).
  ...
  var Dropdown =
      ...
      function() {
        ...
        Dropdown._clearMenus = function _clearMenus(event) {
          if (event &&
              (event.which === RIGHT_MOUSE_BUTTON_WHICH || event.type ===
  ...
  $(document).
      on(Event$4.KEYDOWN_DATA_API, Selector$4.DATA_TOGGLE,
          Dropdown._dataApiKeydownHandler).
      on(Event$4.KEYDOWN_DATA_API, Selector$4.MENU,
          Dropdown._dataApiKeydownHandler).
      on(Event$4.CLICK_DATA_API + ' ' + Event$4.KEYUP_DATA_API,
          Dropdown._clearMenus).
  ...
  var Modal =
      ...
      function() {
        ...
        _proto.show = function show(relatedTarget) {
          ...
          $(this._element).
              on(Event$5.CLICK_DISMISS, Selector$5.DATA_DISMISS,
                  function(event) {
          ...
          if (this._isBodyOverflowing) {
            ...
            $(fixedContent).each(function(index, element) {
              ...
              $(element).
                  ...
                  css('padding-right',
                      parseFloat(calculatedPadding) + _this9._scrollbarWidth +
                      'px');
            ...
            $(stickyContent).each(function(index, element) {
              ...
              $(element).
                  ...
                  css('margin-right',
                      parseFloat(calculatedMargin) - _this9._scrollbarWidth +
                      'px');
            }); // Adjust body padding
      ...
      function() {
        ...
        _proto.show = function show() {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            var isInTheDom = $.contains(shadowRoot !== null ?
                shadowRoot :
        ...
        _proto._setListeners = function _setListeners() {
          ...
          triggers.forEach(function(trigger) {
            if (trigger === 'click') {
              $(_this4.element).
                  on(_this4.constructor.Event.CLICK, _this4.config.selector,
                      function(event) {
        ...
        _proto._getConfig = function _getConfig(config) {
          ...
          config = _objectSpread({}, this.constructor.Default, dataAttributes,
              typeof config === 'object' && config ? config : {});
  ...
  var BSCLS_PREFIX_REGEX$1 = new RegExp('(^|\\s)' + CLASS_PREFIX$1 + '\\S+',
      'g');
  ...
  var ScrollSpy =
      ...
      function() {
        ...
        _proto._getConfig = function _getConfig(config) {
          config = _objectSpread({}, Default$6,
              typeof config === 'object' && config ? config : {});
        ...
        _proto._process = function _process() {
          ...
          for (var i = offsetLength; i--;) {
            var isActiveTarget = this._activeTarget !== this._targets[i] &&
                ...
                (typeof this._offsets[i + 1] === 'undefined' || scrollTop <
                    this._offsets[i + 1]);
      ...
      function() {
        ...
        _proto._activate = function _activate(element, container, callback) {
          ...
          var isTransitioning = callback && active &&
              $(active).hasClass(ClassName$9.FADE);
  ...
  var Toast =
      ...
      function() {
        ...
        _proto._getConfig = function _getConfig(config) {
          config = _objectSpread({}, Default$7, $(this._element).data(),
              typeof config === 'object' && config ? config : {});
