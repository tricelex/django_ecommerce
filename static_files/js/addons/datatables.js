...
(function($, window, document, undefined) {
  ...
  var DataTable = function(options) {
    ...
    this.each(function() {
      ...
      if (this.nodeName.toLowerCase() != 'table') {
        _fnLog(null, 0, 'Non-table node initialisation (' + this.nodeName + ')',
            2);
        return;
      }
      ...
      var loadedInit = function() {
        ...
        _fnCallbackReg(oSettings, 'aoDrawCallback', function() {
          if (oSettings.bSorted || _fnDataSource(oSettings) === 'ssp' ||
        ...
        } else if (oSettings.bDeferLoading || _fnDataSource(oSettings) ==
            'dom') {
  ...
  function _fnScrollDraw(settings) {
    ...
    _fnApplyToChildren(function(nSizer, i) {
      nSizer.innerHTML = '<div class="dataTables_sizing">' + headerContent[i] +
          '</div>';
  ...
  $.extend(_Api.prototype, {
    ...
    iterator: function(flatten, type, fn, alwaysNew) {
      ...
      for (i = 0, ien = context.length; i < ien; i++) {
        ...
        } else if (type === 'column' || type === 'column-rows' || type ===
            'row' || type === 'cell') {
  ...
  var _selector_run = function(type, selector, selectFn, settings, opts) {
    ...
    if (!selector || selectorType === 'string' || selectorType === 'function' ||
