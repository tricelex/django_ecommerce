...
(function($) {
  ...
  HDisplay.prototype.show = function() {
    ...
    if (parentElement.hasClass('in') ||
        parentElement.hasClass('zmd-hierarchical-displaying')) return;
  ...
  HDisplay.prototype.hide = function() {
    ...
    if (parentElement.css('visibility') === 'hidden' ||
        parentElement.hasClass('zmd-hierarchical-displaying')) return;
  ...
  HDisplay.prototype._complete = function(eventName) {
    this.$element.removeClass('zmd-hierarchical-displaying').
        toggleClass('in').
  ...
  function Plugin(settings) {
    return this.each(function() {
      ...
      var options = $.extend({}, HDisplay.DEFAULTS, $this.data(),
          typeof settings === 'object' && settings);

      if (!data) {
        $this.data('zmd.hierarchicalDisplay',
